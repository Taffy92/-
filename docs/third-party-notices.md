...
| --- | --- | --- | --- | --- | --- | --- |
| Next.js 静态网站产物 | `apps/web/out` | 目录 | 361 | 595.96 MB | - | 在线版和离线版共用的静态页面、JS、CSS 和静态资源。 |
...
| Windows NSIS 安装包 | `release/v2.0.0/installers/万能格式转换器_2.0.0_x64-setup.exe` | 文件 | 1 | 262.46 MB | 8BF3361BE8FED6C6123AD51B90D6298319AEFB9EE3C2A6143F4ABDD900886E3B | 离线版 Windows x64 EXE 安装包。 |
| Windows MSI 安装包 | `release/v2.0.0/installers/万能格式转换器_2.0.0_x64_zh-CN.msi` | 文件 | 1 | 272.80 MB | C992027904CAC48B77DD3FB79F11314D3D2689AC4E09161822BDA64B0D5DACFB | 离线版 Windows x64 MSI 安装包。 |
