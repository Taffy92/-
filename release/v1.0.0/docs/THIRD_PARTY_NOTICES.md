...
- 生成时间：2026-05-24T15:30:00+08:00
- npm 依赖数量：835
- 直接 npm 依赖数量：33
- Rust crate 数量：415
- 构建产物记录数量：5
...
| --- | --- | --- | --- | --- | --- | --- |
| Next.js 静态网站产物 | `apps/web/out` | 目录 | 264 | 43.78 MB | - | 在线版和离线版共用的静态页面、JS、CSS 和静态资源。 |
...
| Windows NSIS 安装包 | `apps/desktop/src-tauri/target/release/bundle/nsis/万能格式转换器_1.0.0_x64-setup.exe` | 文件 | 1 | 245.69 MB | 0C86FC2BFDA97297A2858337E7BA67AD7AD275F063D8095D7CCD841A82F8F0D1 | 离线版 Windows x64 EXE 安装包。 |
| Windows MSI 安装包 | `apps/desktop/src-tauri/target/release/bundle/msi/万能格式转换器_1.0.0_x64_zh-CN.msi` | 文件 | 1 | 256.51 MB | A4F42391A8272AB4041FFEC34015BFED90D606531011BC62ABB3F91F63623C0D | 离线版 Windows x64 MSI 安装包。 |
